# Astra hacking Penatesing tools
#Jangan Recode asw
...
logo = '\x1b[1;97m\n\x1b[1;93mTools :   \x1b[1;96mAstra hacker-Cracker\x1b[1;97m\n\x1b[1;93mCreator :Astra Hackes\x1b[1;97m\x1b[1;96m\x1b[1;97m \x1b[1;97m\n\x1b[1;93mTeam :  \x1b[1;91mBlack Coder Crush,Silent Ghost\n'
...
print '\x1b[1;96m   *Astra Hacks*   \    /   '
print '\x1b[1;96m  \ Crack Facebook\  \  /    '
print '\x1b[1;96m  /Contact me whatsapp:+919685607490\/     ' 
...
def login():
    os.system('clear')
    os.system("figlet Astra Hacks |lolcat")
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCTVfd9WxkqSboDEOibOXyrA/featured')
                time.sleep(2)
                menu()
...
def pilih():
    zedd = raw_input('\x1b[1;96mroot@ASTRA ')
    if zedd == '':
